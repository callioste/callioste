...
- **Freelance client website (WordPress)**  
  Designed and developed a responsive website based on client requirements. Customized layout, content structure, and styling using WordPress.
  [Live Demo] https://mobilowalls.pl/
